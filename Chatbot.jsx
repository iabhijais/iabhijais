          ...
          >
            ...
            <div 
              className={`px-4 py-3 flex items-center gap-3 ${
                isDark ? 'bg-gradient-to-r from-fuchsia-500/20 to-cyan-500/20 border-b border-white/10' : 'bg-gradient-to-r from-purple-50 to-blue-50 border-b border-gray-100'
              }`}
