        ...
        >
            ...
            >
                <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
                    ...
                    {/* Desktop Nav */}
                    <nav className="hidden md:flex items-center gap-0 text-base font-semibold">
                        <Link className={`nav-link-tab cursor-pointer transition-all duration-300 px-4 py-2 relative`} to="/" onClick={handleHomeClick}>Home</Link>
                        ...
                        <Link className={`nav-link-tab cursor-pointer transition-all duration-300 px-4 py-2 relative`} to="/#about-section" onClick={handleAboutClick}>About</Link>
                        <Link className={`nav-link-tab cursor-pointer transition-all duration-300 px-4 py-2 relative`} to="/hire-me">Hire Me</Link>
                        <Link className={`nav-link-tab cursor-pointer transition-all duration-300 px-4 py-2 relative`} to="/resume">Resume</Link>
                        <button
                            onClick={toggleTheme}
