  ...
  const projects = [
    {
      ...
      description: "Featured in Lablab.ai's Global Top 30 AI Apps (from thousands of submissions worldwide) during the AI Genesis Hackathon 2025. A solo 48-hour build, Project Hawkkeyed orchestrates Gemini 2.0, GPT-5, and Claude to transform raw data/content into automated summaries, insights, and reports. Achieved a 5/5 Presentation Score.",
