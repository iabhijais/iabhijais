  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      >
        ...
        {/* Resume Viewer */}
        <div
          className={`w-full h-[85vh] rounded-2xl overflow-hidden border ${isDark ? 'border-white/10 bg-white/5' : 'border-gray-200 bg-gray-50'} shadow-2xl relative group mb-8`}
